        ...
        <div class="card shadow-sm">
            <div class="card-body">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        <p><strong>Data:</strong> <?= htmlspecialchars($evento['dataEvento'], ENT_QUOTES, 'UTF-8') ?>
                        </p>
                    </div>
                </div>
                            ...
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                <div>
                                    ...
                                    <span class="text-muted">-
                                        <?= htmlspecialchars($participante['email'], ENT_QUOTES, 'UTF-8') ?></span>
                                </div>
                                <?php if (isset($_SESSION['admin_id'])): ?>
                                    <div class="d-flex gap-2">
                                        <form action="/app-jabulani/removerParticipante" method="post" class="m-0">
                                            <input type="hidden" name="idUsuario"
                                                value="<?= htmlspecialchars($participante['idUsuario'], ENT_QUOTES, 'UTF-8') ?>">
                                        ...
                                        <form action="/app-jabulani/excluirUsuario" method="post" class="m-0">
                                            ...
                                            <input type="hidden" name="redirectTo"
                                                value="/app-jabulani/detalhesEvento?id=<?= htmlspecialchars($evento['id'], ENT_QUOTES, 'UTF-8') ?>">
                                        </form>
                                    </div>
                                <?php endif; ?>
                            </li>
                ...
                <div class="mt-4">
                    <a href="/app-jabulani/exportarEventoXml?id=<?= htmlspecialchars($evento['id'], ENT_QUOTES, 'UTF-8') ?>"
                        class="btn btn-outline-dark btn-sm">Baixar XML</a>
                    <a href="/app-jabulani/exportarEventoPdf?id=<?= htmlspecialchars($evento['id'], ENT_QUOTES, 'UTF-8') ?>"
                        class="btn btn-outline-secondary btn-sm">Baixar PDF</a>
